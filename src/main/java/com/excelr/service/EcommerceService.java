...
import org.json.JSONObject;
	  ...
	  public class EcommerceService {
	      ...
	      @Value("${aws.s3.bucket.name}")
	  	 ...
	  	 private final S3Client s3Client = S3Client.builder()
	  	            ...
	  	            .credentialsProvider(StaticCredentialsProvider.create(
	  	                AwsBasicCredentials.create("AKIA2YICAVFERR3COKGL", "drefpz/NoqyxvBECXwGnKjCuWNDHZcRGjY0OuZC8")
	  	            ))
	  	            .build();
		  ...
		  public User updateUserRole(Long id, String newRole) {
	  	 ...
	  	 public Laptops saveLaptop(String name,String description, int price, int qty, MultipartFile file) throws IOException {
	  	 ...
	  	 public Mobiles saveMobiles(String name,String description, int price, int qty, MultipartFile file) throws IOException {
	  	        String fileName = System.currentTimeMillis() + "_" + file.getOriginalFilename();
	  	        try {
	  	 ...
	  	 public Cosmetics saveCosmetics(String name,String description, int price, int qty, MultipartFile file) throws IOException {
	  	        String fileName = System.currentTimeMillis() + "_" + file.getOriginalFilename();
	  	        try {
	  	            s3Client.putObject(
	  	                PutObjectRequest.builder()
	  	 ...
	  	 public Electronics saveElectronics(String name,String description, int price, int qty, MultipartFile file) throws IOException {
	  	        String fileName = System.currentTimeMillis() + "_" + file.getOriginalFilename();
	  	        try {
	  	            s3Client.putObject(
	  	                PutObjectRequest.builder()
	  	 ...
	  	 public Footwear saveFootwear(String name,String description, int price, int qty, MultipartFile file) throws IOException {
	  	        String fileName = System.currentTimeMillis() + "_" + file.getOriginalFilename();
	  	        try {
	  	            s3Client.putObject(
	  	                PutObjectRequest.builder()
	  	 ...
	  	 public Grocery saveGrocery(String name,String description, int price, int qty, MultipartFile file) throws IOException {
	  	        String fileName = System.currentTimeMillis() + "_" + file.getOriginalFilename();
	  	        try {
	  	            s3Client.putObject(
	  	                PutObjectRequest.builder()
	  	 ...
	  	 public KidsClothing saveKidsClothing(String name,String description, int price, int qty, MultipartFile file) throws IOException {
	  	        String fileName = System.currentTimeMillis() + "_" + file.getOriginalFilename();
	  	        try {
	  	            s3Client.putObject(
	  	                PutObjectRequest.builder()
	  	 ...
	  	 public MenClothing saveMenClothing(String name,String description, int price, int qty, MultipartFile file) throws IOException {
	  	        String fileName = System.currentTimeMillis() + "_" + file.getOriginalFilename();
	  	        try {
	  	            s3Client.putObject(
	  	                PutObjectRequest.builder()
	  	 ...
	  	 public WomenClothing saveWomenClothing(String name,String description, int price, int qty, MultipartFile file) throws IOException {
	  	        String fileName = System.currentTimeMillis() + "_" + file.getOriginalFilename();
	  	        try {
	  	            s3Client.putObject(
	  	                PutObjectRequest.builder()
	      ...
	      public KidsClothing updateKidsClothing(Long id, String name, String description, int price, int qty, MultipartFile file) {
	      ...
	      public MenClothing updateMenClothing(Long id, String name, String description, int price, int qty, MultipartFile file) {
	      ...
	      public WomenClothing updateWomenClothing(Long id, String name, String description, int price, int qty, MultipartFile file) {
	      ...
	      public Electronics updateElectronics(Long id, String name, String description, int price, int qty, MultipartFile file) {
